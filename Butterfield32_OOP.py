...
class Window(Tk):
    ...
    def __init__(self):
        ...
        btn_create_file_payment = Button(tab_payment, text='4) Создать', font=('Arial Bold', 20),
                                         command=Student.generate_list_payment)
...
class Student():
  ...
  #         """
        ...
        print(output_lst_academ)
        print(output_lst_social)
